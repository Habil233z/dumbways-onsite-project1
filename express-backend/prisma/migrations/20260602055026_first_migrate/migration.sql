...
-- AddForeignKey
ALTER TABLE "Threads" ADD CONSTRAINT "Threads_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "Users"("full_name") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Threads" ADD CONSTRAINT "Threads_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "Users"("full_name") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Likes" ADD CONSTRAINT "Likes_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "Users"("full_name") ON DELETE RESTRICT ON UPDATE CASCADE;
