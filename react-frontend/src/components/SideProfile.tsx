...
export default function SideProfile() {
    ...
    return (
        <div className="w-[33%] bg-gray-100 pt-20 flex justify-center" id="SideProfile">
            <div className="h-100 w-80 bg-white border-gray-950 border-2 flex flex-col items-center rounded-4xl" onClick={handleClick}>
